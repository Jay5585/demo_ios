...
#define DefaultProgressBarProgressColor UIColorFromRGBWithAlpha(0xE25C01, 1.0f)
#define DefaultProgressBarTrackColor UIColorFromRGBWithAlpha(0x555555, 1.0f)
const CGFloat DefaultProgressBarWidth = 5.0f;

// Hint View Defaults
#define DefaultHintBackgroundColor UIColorFromRGBWithAlpha(0xffffff, 1.0f)
#define DefaultHintTextFont [UIFont fontWithName:@"HelveticaNeue-CondensedBlack" size:10.0f]
#define DefaultHintTextColor UIColorFromRGBWithAlpha(0x555555, 1.0f)
...
// Animation Constants
const CGFloat AnimationChangeTimeDuration = 0.4f;
...
- (void)drawRect:(CGRect)rect {
    ...
    CGFloat radius = MIN(innerCenter.x - 5, innerCenter.y - 5);
...
- (void)drawBackground:(CGContextRef)context {
    CGContextSetFillColorWithColor(context, UIColorFromRGBWithAlpha(0xffffff, 1.0f).CGColor);
