...
class Statistics: NSObject,NSMutableCopying {
    
    
    // MARK: - Attributes -
    
    var scoreAverage : String = "0"
    var count : String = "0"
    ...
    private func getMutable() -> Statistics{
        
        let object : Statistics = Statistics()
        object.scoreAverage = self.scoreAverage
