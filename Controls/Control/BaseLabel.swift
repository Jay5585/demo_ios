    ...
    */
    ...
    func setCommonProperties(){
        ...
        case .large:
            ...
            self.textColor = Color.lablePrimary.value
        ...
        case .small:
            ...
            self.font = UIFont(name: FontStyle.regular, size: 12.0)
            self.textColor = Color.labelText.value
            self.textAlignment = .center
            break
            
        case .smallest:
            self.font = UIFont(name: FontStyle.regular, size: 11.0)
            self.textColor = Color.labelText.value
            self.textAlignment = .center
            break
            
        case .headerLarge:
            self.font = UIFont(name: FontStyle.bold, size: 30.0)
            self.textColor = Color.lableSecondry.value
            self.textAlignment = .center
            break
            
        case .headerSmall:
            self.font = UIFont(name: FontStyle.bold, size: 22.0)
            self.textColor = Color.lablePrimary.value
            self.textAlignment = .center
            break
